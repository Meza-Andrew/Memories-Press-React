        ...
        front: {
          elements: {
            ...
            dob: {
              ...
              width: 310,
              height: 30,
              font: { family: 'PoppinsRegular', size: '7px', weight: 'normal', color: '#444' },
              hasText: true,
            },
            dod: {
              x: 385,
        ...
        front: {
          elements: {
            ...
            dob: {
              ...
              width: 310,
              height: 30,
              font: { family: 'PoppinsRegular', size: '7px', weight: 'normal', color: '#000' },
              hasText: true,
            },
            dod: {
              x: 385,
        ...
        front: {
          elements: {
            ...
            dob: {
              ...
              width: 310,
              height: 30,
              font: { family: 'PoppinsRegular', size: '7px', weight: 'normal', color: '#fff' },
              hasText: true,
            },
            dod: {
              x: 385,
        ...
        front: {
          elements: {
            ...
            dob: {
              ...
              width: 400,
              height: 30,
              font: { family: 'PoppinsRegular', size: '7px', weight: 'normal', color: 'gold', },
              hasText: true,
            },
            dod: {
              x: 350,
        ...
        back: {
          elements: {
            ...
            dob: {
              ...
              width: 400,
              height: 30,
              font: { family: 'PoppinsRegular', size: '7px', weight: 'normal', color: '#080164', },
              hasText: true,
            },
            dod: {
              x: 461,
      ...
      //template 3
      {
        ...
        back: {
          elements: {
            ...
            //   width: 400,
            //   height: 30,
            //   font: { family: 'PoppinsRegular', size: '18px', weight: 'normal', color: '#555', },
            //   hasText: true,
            // },
            // dod: {
            //   x: 125,
